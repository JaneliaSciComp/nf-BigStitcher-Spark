# JaneliaSciComp/nf-bigstitcher: Usage
...
```bash
nextflow run JaneliaSciComp/nf-bigstitcher -profile docker -params-file params.yaml
```
...
```bash
nextflow pull JaneliaSciComp/nf-bigstitcher
```
